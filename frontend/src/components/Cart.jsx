        ...
        <div>
              ...
              (
                <div className="cart-item" key={cartItem._id}>
                  ...
                  <div className="cart-product">
                    ...
                    <div>
                  <Link to ={`/product/${cartItem._id}`}> {/*add it to image*/}
                      <h3>{cartItem.name}</h3>
                      </Link>
                      <p>{cartItem.desc}</p>
          ...
          <div className="cart-summary">
            ...
            <div className="cart-checkout">
              ...
              {auth._id ? (<PayButton cartItems = {cart.cartItems}/>):(<button className="cart-login" onClick={()=>navigate("/login")}>Login to Check out</button>)}
