    ...
    <div>
      ...
      <Dialog open={open} onClose={handleClose} fullWidth={true} maxWidth={"md"}>
        ...
        <StyledForm onSubmit={handlesubmit}>
            ...
            <input type="text" placeholder="Short Description" required  value={desc} onChange={(e)=> setDesc(e.target.value)} />
        ...
        {/* <ImagePreview>
          {previewImg?<>
          <img src={previewImg} alt="product Image" /></>:<p>Image preview will appear here!</p>}
        </ImagePreview> */}
    </StyledEditProduct>
        </DialogContent>
        <DialogActions>
